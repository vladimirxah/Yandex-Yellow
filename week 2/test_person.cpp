...
void TestExample () {
	...
	p.ChangeLastName(1968, "Sergeeva");
	...
	AssertEqual(p.GetFullName(1966), "Polina with unknown last name");
	AssertEqual(p.GetFullName(1968), "Polina Sergeeva");
	AssertEqual(p.GetFullName(1969), "Polina Sergeeva");
	p.ChangeLastName(1966, "Duhareva");
	AssertEqual(p.GetFullName(1966), "Polina Duhareva");
	AssertEqual(p.GetFullName(2456), "Polina Sergeeva");
	p.ChangeFirstName(1970, "Appolinaria");
	AssertEqual(p.GetFullName(1969), "Polina Sergeeva");
	AssertEqual(p.GetFullName(1970), "Appolinaria Sergeeva");
	AssertEqual(p.GetFullName(1966), "Polina Duhareva");

	p.ChangeLastName(1960, "Hrenova");
	AssertEqual(p.GetFullName(0), "Incognito");
	AssertEqual(p.GetFullName(1959), "Incognito");
	AssertEqual(p.GetFullName(1960), "Hrenova with unknown first name");
	AssertEqual(p.GetFullName(1964), "Hrenova with unknown first name");
	AssertEqual(p.GetFullName(1965), "Polina Hrenova");
	AssertEqual(p.GetFullName(1966), "Polina Duhareva");
	AssertEqual(p.GetFullName(1967), "Polina Duhareva");
	AssertEqual(p.GetFullName(1968), "Polina Sergeeva");
	AssertEqual(p.GetFullName(1969), "Polina Sergeeva");
	AssertEqual(p.GetFullName(1970), "Appolinaria Sergeeva");
	AssertEqual(p.GetFullName(1977), "Appolinaria Sergeeva");
	...
	p.ChangeLastName(1968, "Ivanova");
	AssertEqual(p.GetFullName(1969), "Polina Ivanova");
	AssertEqual(p.GetFullName(1970), "Appolinaria Ivanova");*/
...
int main() {
  TestRunner runner;
  runner.RunTest(TestExample, "TestExample");
